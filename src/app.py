...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap swimming, water safety, and friendly competitions",
    ...
    "Art Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["sophia@mergington.edu", "ella@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and theater workshops",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["owen@mergington.edu", "ava@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice argumentative speaking and debate competitions",
